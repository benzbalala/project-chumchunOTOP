    ...
    methods: {
        ...
        addToCartClicked() {
            if (this.product) {
                ...
                axios
                    .get("http://localhost:8081/products/getCart", {
                        params: {
                    ...
                    .then((response) => {
                        ...
                        const existingCartItem = cartItems.find(
                            (item) =>
                                ...
                                item.productTypes === selectedProductType
                        );

                        if (existingCartItem) {
                            axios
                                .put(
                                    `http://localhost:8081/products/updateCartQuantity/${existingCartItem.id}`,
                                    {
                            ...
                            axios
                                .post(
                                    "http://localhost:8081/products/createCartEntry",
                                    productData
                                )
                                .then((response) => {
        ...
        increment() {
            if (this.count < this.product.numberProducts || 0) {
                this.count++;
            }
            console.log("this.count", this.count);
        },
